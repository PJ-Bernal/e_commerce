...
ActiveRecord::Schema[7.1].define(version: 2024_07_18_164506) do
  ...
  create_table "static_about_pages", force: :cascade do |t|
    t.text "mission"
    t.text "vision"
    t.text "story"
    t.text "value"
  ...
  create_table "static_contact_pages", force: :cascade do |t|
    t.text "title"
